...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public static final double ALGAE_LEVEL_TWO_THREE = 16; // untested
  public static final double ALGAE_LEVEL_TWO_THREE_FLING = 16;
  public static final double ALGAE_LEVEL_THREE_FOUR = 25; // untested
  ...
  public static final double ALGAE_NET_SCORE = 37.5; // untested
