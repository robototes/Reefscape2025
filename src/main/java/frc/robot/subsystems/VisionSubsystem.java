...
public class VisionSubsystem extends SubsystemBase {
  ...
  private static final double CAMERA_X_POS_METERS_FRONT = Units.inchesToMeters(0);
  private static final double CAMERA_X_POS_METERS_BACK = Units.inchesToMeters(0);
  private static final double CAMERA_Y_POS_METERS = 0;
  private static final double CAMERA_Z_POS_METERS = Units.inchesToMeters(0);
  ...
  private static final double CAMERA_PITCH_BACK = Units.degreesToRadians(0);
  ...
  private void process(PhotonPipelineResult result, PhotonPoseEstimator estimator) {
    ...
    if (estimatedPose.isPresent()) {
      ...
      var Distance =
      roundUpToOneDecimalPlace(PhotonUtils.getDistanceToPose(
              FieldPose,
  ...
  public double roundUpToOneDecimalPlace(double num) {
