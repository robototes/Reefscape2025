...
public class AutoLogic {
  ...
  static Supplier<Pose2d> supplier = () -> s.drivebaseSubsystem.getState().Pose;
    ...
    public static void registerCommands() {
      ...
      NamedCommands.registerCommand("autopilot", autoPilotCommand());
      NamedCommands.registerCommand("align", autoAlignCommand());
    }
  ...
  public static Command autoAlignCommand () {
    return AutoAlign.autoAlign(s.drivebaseSubsystem, controls, AlignType.ALLB);
  }
