...
public class AutoAlign {
  ...
  private static final List LeftBlueReefFaces =
      List.of(
          lRedReefFaceAB,
          lRedReefFaceCD,
          lRedReefFaceEF,
          ...
          lRedReefFaceIJ,
          lRedReefFaceKL);
  private static final List LeftRedReefFaces =
      List.of(
          lRedReefFaceAB,
          lRedReefFaceCD,
          lRedReefFaceEF,
  ...
  private static final List RightBlueReefFaces =
      List.of(
          rBlueReefFaceAB,
          rBlueReefFaceCD,
          rBlueReefFaceEF,
          ...
          rBlueReefFaceIJ,
          rBlueReefFaceKL);
  private static final List RightRedReefFaces =
      List.of(
          rRedReefFaceAB,
          rRedReefFaceCD,
          rRedReefFaceEF,
  ...
  private static class AutoAlignCommand extends Command {
    ...
    public static Pose2d getTargetPose(Pose2d pose, AlignType type) {
      return switch (type) {
        case LEFTB -> getNearestBranch(pose, BlueBranches, RedBranches);
    ...
    private static Pose2d getNearestBranch(Pose2d p, List blueBranch, List redBranch) {
      List<Pose2d> branchPose2ds = AllianceUtils.isBlue() ? blueBranch : redBranch;
