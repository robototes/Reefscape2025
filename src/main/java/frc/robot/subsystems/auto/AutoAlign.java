...
public class AutoAlign {
  ...
  private static final Pose2d BRANCH_R_A =
      new Pose2d(new Translation2d(14.35, 3.85), Rotation2d.fromDegrees(180));
  private static final Pose2d BRANCH_R_B =
      new Pose2d(new Translation2d(14.354, 4.184), Rotation2d.fromDegrees(180));
  private static final Pose2d BRANCH_R_C =
      new Pose2d(new Translation2d(13.845, 5.073), Rotation2d.fromDegrees(240));
  private static final Pose2d BRANCH_R_D =
      new Pose2d(new Translation2d(13.557, 5.252), Rotation2d.fromDegrees(240));
  private static final Pose2d BRANCH_R_E =
      new Pose2d(new Translation2d(12.554, 5.230), Rotation2d.fromDegrees(-60));
  private static final Pose2d BRANCH_R_F =
      new Pose2d(new Translation2d(12.275, 5.065
      ), Rotation2d.fromDegrees(300));
        //START FROM HERE AFTERWARDS!  
  private static final Pose2d BRANCH_R_G =
      new Pose2d(new Translation2d(11.771, 4.19), Rotation2d.fromDegrees(0));
  private static final Pose2d BRANCH_R_H =
      new Pose2d(new Translation2d(11.769, 3.866), Rotation2d.fromDegrees(0));

  private static final Pose2d BRANCH_R_I =
      new Pose2d(new Translation2d(12.29, 2.95), Rotation2d.fromDegrees(60));
  private static final Pose2d BRANCH_R_J =
      new Pose2d(new Translation2d(12.565, 2.82), Rotation2d.fromDegrees(60));
  private static final Pose2d BRANCH_R_K =
      new Pose2d(new Translation2d(13.558, 2.80), Rotation2d.fromDegrees(120));
  private static final Pose2d BRANCH_R_L =
      new Pose2d(new Translation2d(13.88, 2.996), Rotation2d.fromDegrees(120));
