...
public class AutoAlign {
  ...
  private static final Pose2d BRANCH_B_D =
      new Pose2d(new Translation2d(3.997, 2.861), Rotation2d.fromDegrees(60));
  private static final Pose2d BRANCH_B_E =
      new Pose2d(new Translation2d(5.019, 2.861), Rotation2d.fromDegrees(120));
  ...
  private static final Pose2d BRANCH_B_J =
      new Pose2d(new Translation2d(5.019, 5.287), Rotation2d.fromDegrees(240));
  private static final Pose2d BRANCH_B_K =
      new Pose2d(new Translation2d(3.997, 5.287), Rotation2d.fromDegrees(300));
  ...
  private static final Pose2d BRANCH_R_A =
      new Pose2d(new Translation2d(14.350, 3.867), Rotation2d.fromDegrees(180));
  private static final Pose2d BRANCH_R_B =
      new Pose2d(new Translation2d(14.350, 4.188), Rotation2d.fromDegrees(180));
  private static final Pose2d BRANCH_R_C =
      new Pose2d(new Translation2d(13.869, 5.039), Rotation2d.fromDegrees(240));
  private static final Pose2d BRANCH_R_D =
      new Pose2d(new Translation2d(13.553, 5.189), Rotation2d.fromDegrees(240));
  private static final Pose2d BRANCH_R_E =
      new Pose2d(new Translation2d(12.576, 5.189), Rotation2d.fromDegrees(300));
  private static final Pose2d BRANCH_R_F =
      new Pose2d(new Translation2d(12.276, 5.039), Rotation2d.fromDegrees(300));
  private static final Pose2d BRANCH_R_G =
      new Pose2d(new Translation2d(11.765, 4.188), Rotation2d.fromDegrees(0));
  private static final Pose2d BRANCH_R_H =
      new Pose2d(new Translation2d(11.765, 3.867), Rotation2d.fromDegrees(0));
  private static final Pose2d BRANCH_R_I =
      new Pose2d(new Translation2d(12.276, 2.981), Rotation2d.fromDegrees(60));
  private static final Pose2d BRANCH_R_J =
      new Pose2d(new Translation2d(12.576, 2.830), Rotation2d.fromDegrees(60));
  private static final Pose2d BRANCH_R_K =
      new Pose2d(new Translation2d(13.553, 2.830), Rotation2d.fromDegrees(120));
  private static final Pose2d BRANCH_R_L =
      new Pose2d(new Translation2d(13.869, 2.981), Rotation2d.fromDegrees(120));
