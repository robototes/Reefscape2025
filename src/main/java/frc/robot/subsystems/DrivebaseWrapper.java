...
/**
 * Wrapper class around members of {@link SwerveDrive}, like the Field2d
 * telemetry and the pose
 * estimator.
 */
public class DrivebaseWrapper {
    ...
    public DrivebaseWrapper() {
        ...
        var dummyModulePositions = new SwerveModulePosition[] { new SwerveModulePosition(),
     ...
     * @param timestamp Timestamp of the vision measurement in seconds since FPGA
     *                  startup.
     * @param stdDevs   The standard deviations of the vision measurement. (X
