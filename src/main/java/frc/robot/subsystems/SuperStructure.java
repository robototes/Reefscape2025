...
public class SuperStructure {
    ...
    public Command levelOne(BooleanSupplier score, BooleanSupplier intake, BooleanSupplier holding) {
        return Commands.sequence(
            ...
            Commands.waitUntil(score),
            levelOneScore(),
            intake(intake, holding) //ok this is iffy and now im just making things up... unsure whether this works
        );
    }
    public Command stow() {
        return Commands.parallel(
    ...
    public Command intake(BooleanSupplier intake, BooleanSupplier holding) { //not sure if boolean supplier will work to check using sensors
        return Commands.parallel(
            stow(),
