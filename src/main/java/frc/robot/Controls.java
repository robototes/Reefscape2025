...
public class Controls {
    ...
    // drivebase it is
    public static final double MaxSpeed = RobotType.getCurrent() == RobotType.BONK
    ...
    public static double MaxAngularRate = RotationsPerSecond.of(0.75)
    ...
    // takes the rotation value from the joystic, and applies a deadband and input
    // scaling
    ...
    private void configureDrivebaseBindings() {
        ...
        var swerveCoastButton = Shuffleboard.getTab("Controls")
    ...
    private void configureSuperStructureBindings() {
        ...
        driverController
                .a()
                .onTrue(s.elevatorSubsystem.runOnce(() -> {
                }).withName("elevator interruptor"))
                .onTrue(
                        Commands.runOnce(
                                () -> {
                                    Command intakeCommand = switch (scoringMode) {
                                        case CORAL -> superStructure
                                                .coralIntake()
                                                .alongWith(
                                                        s.elevatorLEDSubsystem != null
                                                                ? s.elevatorLEDSubsystem
                                                                        .tripleBlink(255, 92, 0,
                                                                                "Orange - Manual Coral Intake")
                                                                        .asProxy()
                                                                : Commands.none())
                                    ...
                                    Command scoreCommand = switch (scoringMode) {
                                        ...
                                        case ALGAE -> Commands.sequence(
                                                BargeAlign.bargeScore(
                                                        ...
                                                        () -> getDriveY(),
                                                        () -> getDriveRotate(),
                                                        driverController.rightBumper(), s.drivebaseWrapper),
                                                getAlgaeIntakeCommand())
    ...
    private void configureElevatorBindings() {
        ...
        var elevatorCoastButton = Shuffleboard.getTab("Controls")
    ...
    private void configureClimbPivotBindings() {
        ...
        // climb coast button
        var climbCoastButton = Shuffleboard.getTab("Controls")
